    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/20 px-4 py-12">
      <div className="bg-white dark:bg-card border dark:border-border rounded-2xl shadow-sm p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-lg font-bold">{t('createAccount', 'Create an account')}</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          {t('alreadyHaveAccount', 'Already have an account?')} <Link to="/login" className="text-[#F47A3E] font-bold hover:underline">{t('signIn', 'Sign in')}</Link>
        </div>
      </div>
    </div>
  );
