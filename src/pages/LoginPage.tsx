  ...
  return (
    <AuthBackground isTypingPassword={password.length > 0}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link to="/forgot-password" className="text-xs text-[#F47A3E] hover:text-orange-300 font-bold transition-colors">
              {t('forgotPassword')}
            </Link>
          </div>
          <input
      ...
      <p className="mt-6 text-center text-sm text-white/50">
        ...
        <Link to="/signup" className="text-[#F47A3E] font-bold hover:text-orange-300 transition-colors">
          {t('signUp', 'Sign up')}
        </Link>
      </p>
    </AuthBackground>
